...
{
    // Obsoleted because internal key generation is bad practice, 
    // and the feature is redundant with the combination of others.
    error << BX_STEALTH_NEWKEY_OBSOLETE << std::endl;
