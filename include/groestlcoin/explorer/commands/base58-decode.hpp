 ...
 */
#ifndef BX_BASE58_DECODE_HPP
#define BX_BASE58_DECODE_HPP
...
/**
 * Class to implement the base58-decode command.
 */
class base58_decode 
    : public command
{
public:
        ...
        po::variables_map& variables)
    {
        ...
        load_input(get_base58_argument(), "BASE58", variables, input, raw);
    }
     ...
     */
    BCX_API virtual primitives::base58& get_base58_argument()
    {
     ...
     */
    BCX_API virtual void set_base58_argument(
