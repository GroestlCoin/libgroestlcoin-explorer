 ...
 */
#ifndef BX_SENDTX_BCI_HPP
#define BX_SENDTX_BCI_HPP
 ...
 */
#define BX_SENDTX_BCI_OBSOLETE \
    "This command is no longer supported. Use send-tx, send-tx-node or send-tx-p2p."

/**
 * Class to implement the sendtx-bci command.
 */
class sendtx_bci 
    : public command
{
