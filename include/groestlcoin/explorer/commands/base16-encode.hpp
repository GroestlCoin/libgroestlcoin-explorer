 ...
 */
#ifndef BX_BASE16_ENCODE_HPP
#define BX_BASE16_ENCODE_HPP
...
/**
 * Class to implement the base16-encode command.
 */
class base16_encode 
    : public command
{
public:
    ...
    {
        return "Convert binary data to Base16.";
    }
