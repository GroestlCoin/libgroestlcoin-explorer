...
public:
    ...
    {
        return "Convert a Base58Check value to Base16.";
    }
    ...
    BCX_API virtual options_metadata& load_options()
    {
        ...
        (
            "BASE58CHECK",
            value<primitives::base58>(&argument_.base58check),
     ...
     */
    BCX_API virtual primitives::base58& get_base58check_argument()
    {
     ...
     */
    BCX_API virtual void set_base58check_argument(
