...
public:
    ...
    {
        return "Convert a Bitcoin address to its component parts.";
    }
    ...
    BCX_API virtual options_metadata& load_options()
    {
        ...
        (
            ...
            "The Bitcoin address to convert. If not specified the address is read from STDIN."
        );
