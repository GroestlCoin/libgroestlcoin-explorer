 ...
 */
#ifndef BX_BCI_HISTORY_HPP
#define BX_BCI_HISTORY_HPP
 ...
 */
#define BX_BCI_HISTORY_OBSOLETE \
    "This command is no longer supported. Use fetch-history."

/**
 * Class to implement the bci-history command.
 */
class bci_history 
    : public command
{
public:
    ...
    {
        return "Get the list of outputs, values and spends for an address from blockchain.info.";
    }
