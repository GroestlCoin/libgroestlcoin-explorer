 ...
 */
#ifndef BX_WIF_TO_PUBLIC_HPP
#define BX_WIF_TO_PUBLIC_HPP
...
/**
 * Class to implement the wif-to-public command.
 */
class wif_to_public 
    : public command
{
public:
    ...
    {
        return "Derive the EC public key from a WIF private key.";
    }
    ...
    BCX_API virtual options_metadata& load_options()
    {
        ...
        (
            ...
            "The WIF private key. If not specified the value is read from STDIN."
        );
