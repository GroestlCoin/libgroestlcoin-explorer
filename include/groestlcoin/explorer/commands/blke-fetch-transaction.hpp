 ...
 */
#ifndef BX_BLKE_FETCH_TRANSACTION_HPP
#define BX_BLKE_FETCH_TRANSACTION_HPP
 ...
 */
#define BX_BLKE_FETCH_TRANSACTION_OBSOLETE \
    "This command is no longer supported. Use fetch-tx."

/**
 * Class to implement the blke-fetch-transaction command.
 */
...
public:
    ...
    {
        return "Get a Bitcoin transaction from blockexplorer.com.";
    }
