 ...
 */
#ifndef BX_INITCHAIN_HPP
#define BX_INITCHAIN_HPP
 ...
 */
#define BX_INITCHAIN_OBSOLETE \
    "Server administration tools are no longer supported."

/**
 * Class to implement the initchain command.
 */
class initchain 
    : public command
{
public:
    ...
    {
        return "Initialize a new blockchain database.";
    }
