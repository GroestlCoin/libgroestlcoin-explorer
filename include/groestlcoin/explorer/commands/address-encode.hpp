 ...
 */
#ifndef BX_ADDRESS_ENCODE_HPP
#define BX_ADDRESS_ENCODE_HPP
...
/**
 * Class to implement the address-encode command.
 */
...
public:
     ...
     */
    BCX_API virtual primitives::btc160& get_ripemd160_argument()
    {
     ...
     */
    BCX_API virtual void set_ripemd160_argument(
