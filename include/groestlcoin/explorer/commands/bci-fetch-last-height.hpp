 ...
 */
#ifndef BX_BCI_FETCH_LAST_HEIGHT_HPP
#define BX_BCI_FETCH_LAST_HEIGHT_HPP
 ...
 */
#define BX_BCI_FETCH_LAST_HEIGHT_OBSOLETE \
    "This command is no longer supported. Use fetch-height."

/**
 * Class to implement the bci-fetch-last-height command.
 */
class bci_fetch_last_height 
    : public command
{
public:
