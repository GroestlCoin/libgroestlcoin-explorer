...
public:
     ...
     */
    BCX_API virtual std::vector<primitives::ec_private>& get_secrets_argument()
    {
     ...
     */
    BCX_API virtual void set_secrets_argument(
        const std::vector<primitives::ec_private>& value)
    {
