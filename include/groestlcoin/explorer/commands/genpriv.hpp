 ...
 */
#ifndef BX_GENPRIV_HPP
#define BX_GENPRIV_HPP
...
public:
    ...
    {
        return "Create a private key deterministically from an Electrum seed.";
    }
