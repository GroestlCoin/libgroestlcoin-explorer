 ...
 */
#ifndef BX_FETCH_PUBLIC_KEY_HPP
#define BX_FETCH_PUBLIC_KEY_HPP
 ...
 */
#define BX_FETCH_PUBLIC_KEY_NOT_IMPLEMENTED \
    "This command is not yet implemented."

/**
 * Class to implement the fetch-public-key command.
 */
class fetch_public_key 
    : public command
{
public:
    ...
    BCX_API virtual options_metadata& load_options()
    {
        ...
        (
            ...
            "The Bitcoin address of the public key. If not specified the address is read from STDIN."
        );
