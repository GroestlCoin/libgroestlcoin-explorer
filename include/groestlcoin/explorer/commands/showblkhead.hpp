 ...
 */
#ifndef BX_SHOWBLKHEAD_HPP
#define BX_SHOWBLKHEAD_HPP
 ...
 */
#define BX_SHOWBLKHEAD_OBSOLETE \
    "This command is obsolete. Use fetch-header with formatting instead."

/**
 * Class to implement the showblkhead command.
 */
class showblkhead 
    : public command
{
